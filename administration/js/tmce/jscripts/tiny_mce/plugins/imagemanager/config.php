<?php
	...
	if(($_SERVER['HTTP_HOST']=='localhost') || ($_SERVER['HTTP_HOST']=='192.168.0.123') || ($_SERVER['HTTP_HOST']=='192.168.0.125')) {
	$mcImageManagerConfig['filesystem.rootpath'] = 'c:/wamp/www/tinytims/usr/images'; // absolute or relative from this script path, required.
	} else {
	$mcImageManagerConfig['filesystem.rootpath'] = '/home/tinytim/public_html/usr/images'; // absolute or relative from this script path, required.
	}
	...
	$mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "MyIsLoggedInState";
	...
	$mcImageManagerConfig['SessionAuthenticator.rootpath_key'] = "imagemanager.MyRootPath";
