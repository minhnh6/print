<?php
	...
	$mcFileManagerConfig['filesystem.rootpath'] = '/home/tinytim/public_html/usr'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,ppt,pptx,doc,docx,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,mp4,m4v";
	...
	// Upload options
	$mcFileManagerConfig['upload.maxsize'] = "150MB";
	...
	$mcFileManagerConfig['upload.extensions'] = "m4v,mov,mp4,flv,pdf,zip,ppt,pptx,doc,docx";
	...
	$mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = "MyIsLoggedInState";
	...
	$mcFileManagerConfig['SessionAuthenticator.rootpath_key'] = "filemanager.MyRootPath";
