				...
				$(this)
					.hover(
						function(e) {
							...
							//alert($menuGroup.width());
							if($(this).width()<=46) {
								leftnew=-($menuGroup.width()-(2*$(this).width())+2);
								$menuGroup.css({left:leftnew,width:$menuGroup.width(),top:offset.top}).slideDown(100);
							} else {
								leftnew=0;
								$menuGroup.css({left:leftnew,top:offset.top}).slideDown(100);
							}
							
							
						},
						function(e) {
							$menuGroup.slideUp(50);
						}
					)
				;
			});
