...
$(function () {
    $('#file_upload').fileUploadUI({
        ...
        buildDownloadRow: function (file) {
            ...
            return $('<div class="block" style="padding-right:5px;" id="' + file.name + '"><img src="<?php echo IMG_PATH; ?>products/' + file.name + '" height="100" border="0"><div><input type="radio" name="primages[]" id="primages[]" value="' + file.name + '" onclick="javascript:setMainImage(this.value);" checked="checked">Default &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="javascript:removeImage(\'' + file.name + '\');"><img src="images/trash.png" border="0" /></a></div></div>');
        },
...
<table id="files"><tr><td align="center" ></td></tr></table></td>
 ...
 <form id="file_upload" name="file_upload" action="img_up.php" method="post" enctype="multipart/form-data"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">
                            <tr>
                            <td colspan="2" class="admlsttxt bi">
                                <input type="file" name="file" multiple class="bi">
                                <button>Upload</button>
                                <div class="bi">Browse Images</div>
							</td>
                            </tr></table></form>
</body>
</html>